...
private:
    ...
    void save_books_to_file()
    {
        ...
        {
            file << books[i].get_ISBN() << ";" << books[i].get_title() << ";" << books[i].get_author() << ";"
                 << books[i].get_copyright_date() << ";" << static_cast<int>(books[i].get_genre()) << "\n";
        }
    }
    ...
    void save_patrons_to_file()
    {
        ...
        {
            file << patrons[i].get_user_name() << ";" << patrons[i].get_card_number() << ";" << patrons[i].get_owed_fees() << "\n";
        }
    }
    ...
    void save_transactions_to_file()
    {
        ...
        {
            file << transactions[i].book.get_ISBN() << ";" << transactions[i].patron.get_card_number() << ";"
                 << transactions[i].activity << ";" << transactions[i].date << "\n";
        }
    }
...
public:
    ...
    vector<string> patrons_with_fees() const
    {
        ...
        for (int i = 0; i < patrons.size(); ++i)
        {
            if (patrons[i].owes_fees())
                result.push_back(patrons[i].get_user_name());
        }
        return result;
    }
...
int main()
{
    ...
    while (true)
    {
        ...
        cout << "7. Add a patron\n";         // New menu option to add a patron
        cout << "8. Exit\n";
